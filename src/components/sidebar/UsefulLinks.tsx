...
const LinkItem = ({
  ...
  icon,
  label
}: LinkItemProps) => <a href={href} target="_blank" rel="noopener noreferrer" className="flex items-center py-2 text-sm text-white hover:text-white/80 transition-colors">
    {icon}
...
const UsefulLinks = ({
  ...
  return <div className="bg-[#0066FF] rounded-t-2xl rounded-b-none px-6 shadow-md absolute bottom-0 left-0 right-0 max-w-[calc(100%-24px)] mx-auto py-[34px]\n">
